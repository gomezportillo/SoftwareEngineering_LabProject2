...
public class InterfazRegistrarMiembro extends JFrame {
	 ...
	 * Create the frame.
	 */
	public InterfazRegistrarMiembro() {
		setTitle("GoFit - Registrar nuevo miembro");
		...
		btnAltaUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					if(GestorMiembros.nuevoUsuario(textFieldLogin.getText(), textFieldPassword.getText()))
							textPane.setText("Usuario creado correctamente");
					else
							textPane.setText("Usuario ya existente");					
				} catch (Exception e) {
					textPane.setText("Error al cargar base de datos");
					}
			}
		});
		...
		textPane.setToolTipText("Panel para mostrar el restultado de la comprobacion de login o las excepciones lanzadas");
